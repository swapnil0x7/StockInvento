	...
	return (
		<form onSubmit={handleSubmit(onSubmit)} noValidate>
			<div className='flex flex-col items-center gap-1'>
				<img src={usersIcon} alt='users-icon' className='max-h-16 max-w-16' />
			...
			<div className='grid items-start mt-8 md:w-[21rem] lg:w-[23rem]'>
				{isSignUp && (
					<div className='flex flex-col text-gray-500 text-xs my-1'>
						<label>Name</label>
						<input
							style={inputStyle}
							type='text'
				...
				<div className='flex flex-col text-gray-500 text-xs relative '>
					<label>Email</label>
					<input
						style={inputStyle}
						type='email'
				...
				<button
					...
					<img
						src={Google}
						className='md:left-[4.5rem] lg:left-24 absolute w-6 h-6'
						alt='google-logo'></img>
					Sign in with Google
				</button>
			</div>
